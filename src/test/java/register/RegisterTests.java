...
public class RegisterTests extends BaseTest {
    ...
    @Test(priority = 3)
    public void testUnMatchedPasswords() throws InterruptedException{
        homePage.closePopUp();
        AuthenticationPage authenticationPage=homePage.goToSignInPage();
        authenticationPage.enterEmail(email);
        var signUpPage=authenticationPage.continueSigningUp();
    ...
    @Test(priority = 4)
    public void testShortFNameRegistration() throws InterruptedException{
        homePage.closePopUp();
        AuthenticationPage authenticationPage=homePage.goToSignInPage();
        authenticationPage.enterEmail(email);
        var signUpPage=authenticationPage.continueSigningUp();
    ...
    public void testingInvalidNames(String FName, String LName) throws InterruptedException{
        homePage.closePopUp();
        AuthenticationPage authenticationPage=homePage.goToSignInPage();
        authenticationPage.enterEmail(email);
        var signUpPage=authenticationPage.continueSigningUp();
    ...
    @Test(priority = 6)
    public void testInvalidPhoneRegistration() throws InterruptedException{
        homePage.closePopUp();
        AuthenticationPage authenticationPage=homePage.goToSignInPage();
        authenticationPage.enterEmail(email);
        var signUpPage=authenticationPage.continueSigningUp();
